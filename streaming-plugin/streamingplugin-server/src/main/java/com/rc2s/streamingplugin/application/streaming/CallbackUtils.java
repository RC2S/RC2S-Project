 ...
 */
//@SourceControl
public class CallbackUtils extends DefaultAudioCallbackAdapter
{
	...
	private final AlgoEffectUtils algoEffect;
    ...
    private final Logger log = LogManager.getLogger(CallbackUtils.class);
    
    public CallbackUtils(final StreamingService streamingService, 
            final int blockSize, final int[] syncDimensions, char lighteningWanted)
    {
        super(blockSize);
	 ...
	 * 
	 * @param value
	 * @return AlgoEffectUtils the algo effect asked
	 */
	private AlgoEffectUtils getAlgoEffect(final int value)
	{
		switch (value)
		{
			case 0:
				return AlgoEffectUtils.CLASSIC;
				
			case 1:
				return AlgoEffectUtils.MIRROR_WIDTH;
				
			case 2:
				return AlgoEffectUtils.MIRROR_DEPTH;
				
			case 3:
				return AlgoEffectUtils.MIRROR_HEIGHT;
				
			case 4:
				return AlgoEffectUtils.MIRROR_TRIPLE;
				
			case 5:
				return AlgoEffectUtils.EIGHTIFY;
	 ...
	 * @param isStaged
	 */
	private void addGroupPositionsToLighteningList(final int firstXLight, final int x_size, final int pos_y, boolean isStaged)
	{
		int i, j, k;
